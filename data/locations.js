...
const locations = [
  { 
    id: 1, name: '1', cn: '1', x: 12, y: 28, boss: 'Страж Тропы', bossIcon: '🛡️', desc: 'Древняя тропа.', 
  ...
  { 
    id: 2, name: '2', cn: '2', x: 28, y: 38, boss: 'Король Серых Волков', bossIcon: '🐺', desc: 'Каменная теснина.', 
  ...
  { 
    id: 3, name: '3', cn: '3', x: 42, y: 30, boss: 'Теневой Монах', bossIcon: '🧘', desc: 'Заброшенный храм.', 
  ...
  { 
    id: 4, name: '4', cn: '4', x: 62, y: 25, boss: 'Настоятель Ветра', bossIcon: '🌪️', desc: 'Древний храм.', 
  ...
  { 
    id: 5, name: '5', cn: '5', x: 52, y: 45, boss: 'Кровавый Дух', bossIcon: '🩸', desc: 'Озеро крови.', 
  ...
  { 
    id: 6, name: '6', cn: '6', x: 38, y: 55, boss: 'Болотный Колосс', bossIcon: '🦠', desc: 'Гиблое место.', 
  ...
  { 
    id: 7, name: '7', cn: '7', x: 72, y: 38, boss: 'Страж Врат', bossIcon: '🐉', desc: 'Древние врата.', 
  ...
  { 
    id: 8, name: '8', cn: '8', x: 22, y: 65, boss: 'Теневой Владыка', bossIcon: '💀', desc: 'Подземная гробница.', 
  ...
  { 
    id: 9, name: '9', cn: '9', x: 50, y: 70, boss: 'Древний Змей', bossIcon: '🐍', desc: 'Подводная пещера.', 
  ...
  { 
    id: 10, name: '10', cn: '10', x: 78, y: 55, boss: 'Нефритовый Император', bossIcon: '👑', desc: 'Финал.', 
